...
output:
  pdf_document:
    ...
    fig_height: 3.5
abstract: |
  Hey bestie, I wrote you a little report to prove you wrong.
---
...
I've said it before and I'll say it again cloud-er - even though the sun does come out in London, on average, it will not last long.
...
# Sun of a beach
In this first graph, I demonstrate that even though the sun does come out, it will not last long. Therefore, if you try to catch some sun, you will probably mist. Pun intended.
...
# Weather extremes
In this graph, I show that over the past 40 years London has seen some extreme weather conditions. 
...
# Conclusion
In conclusion, it's not always sunshine and rainbows in London and the extreme weather can be irksome.
